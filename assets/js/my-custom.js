$(function (Menu) {
    ...
    $('.showModalEdit').on('click', function (m) {
        ...
        $('.modal-content form').attr('action', 'http://localhost/TE/menu/updatemenu');

        const id = $(this).data('id');

        $.ajax({
            url: 'http://localhost/TE/menu/geteditmenu',
            data: { id: id },
            method: 'post',
            dataType: 'json',
    ...
    $('.showModalEditSub').on('click', function (sm) {
        ...
        $('.modal-footer button[type=submit]').html('Update');
        $('.modal-content form').attr('action', 'http://localhost/TE/menu/updatesubmenu');

        const id = $(this).data('id');

        $.ajax({
            url: 'http://localhost/TE/menu/geteditsubmenu',
            data: { id: id },
            method: 'post',
            dataType: 'json',
            success: function (data) {
...
$(function (Admin) {
    ...
    $('.showEditAdminRoleModal').on('click', function (r) {
        ...
        $('.modal-footer button[type=submit]').html('Update');
        $('.modal-content form').attr('action', 'http://localhost/TE/admin/updaterole');

        const id = $(this).data('id');

        $.ajax({
            url: 'http://localhost/TE/admin/geteditrole',
            data: { id: id },
            method: 'post',
            dataType: 'json',
            success: function (data) {
...
$(function (Event) {
    ...
    $('.showModalEditEvent').on('click', function () {
        ...
        $('.modal-footer button[type=submit]').html('Update');
        $('.modal-content form').attr('action', 'http://localhost/TE/events/updateevent');

        const id = $(this).data('id');

        $.ajax({
            url: 'http://localhost/TE/events/geteditevent',
            data: { id: id },
            method: 'post',
            dataType: 'json',
            success: function (data) {
...
$(function () { //Ticket--------------
    ...
    $('.showEditTicketModal').on('click', function (r) {
        ...
        $('.modal-footer button[type=submit]').html('Update');
        $('.modal-content form').attr('action', 'http://localhost/TE/tickets/updateticket');

        const id = $(this).data('id');

        $.ajax({
            url: 'http://localhost/TE/tickets/geteditticket',
            data: { id: id },
            method: 'post',
            dataType: 'json',
            success: function (data) {
...
$(function () {
    $('.member_active').on('click', function () {
        ...
        if ($('.member_active').attr('checked') == "checked") {
            ...
            $.ajax({
                url: 'http://localhost/TE/admin/changememberactive',
                type: 'post',
                data: {
                    memberId: memberId,
                    memberActive: 0
                ...
                success: function () {
                    document.location.href = "http://localhost/TE/admin/list";
                }
            });
...
$(function () {
    $('.seller_active').on('click', function () {
        ...
        if ($('.seller_active').attr('checked') == "checked") {
            ...
            $.ajax({
                url: 'http://localhost/TE/member/changeselleractive',
                type: 'post',
                data: {
                    sellerId: sellerId,
                    sellerActive: 0
                ...
                success: function () {
                    document.location.href = "http://localhost/TE/member/list";
                }
            });
